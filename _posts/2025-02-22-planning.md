...
tags:
  ...
  - Planning
image:
  path: /assets/img/cover/planning.webp
  alt: "HTB : Planning"
---
...
- Run linpeas.sh:
  ![Description](/assets/img/images/planning1.png)
- Found file that is suspicious inside `/opt/crontab/crontab.db`.
  ![Description](/assets/img/images/planning2.png)
- Found another password.
- After enumeration long time.
  ![Description](/assets/img/images/planning3.png)
...
- We got access to Crontab UI.
  ![Description](/assets/img/images/planning4.png)
